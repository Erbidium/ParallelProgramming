...
public class ThreadPoolFoxMatrixMultiplier implements IMatrixMultiplier {
    private int threadsNumber;

    public ThreadPoolFoxMatrixMultiplier(int threadsNumber)
    {
        this.threadsNumber = threadsNumber;
    }

    public ThreadPoolFoxMatrixMultiplier()
    {
